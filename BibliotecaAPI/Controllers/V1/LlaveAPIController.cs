...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class LlaveAPIController: ControllerBase
    {
        ...
        public LlaveAPIController(ApplicationDbContext context, IMapper mapper, 
            IServicioLlaves servicioLlaves, IServiciosUsuarios serviciosUsuarios)
        {
        ...
        {
            var usuarioId = serviciosUsuarios.ObtenerUsuarioId();
            var llave = await context.LlaveAPIs.FirstOrDefaultAsync(x => x.Id == id);
        ...
        public async Task<ActionResult> Post (LlaveCreacionDTO llaveCreacionDTO)
        {
            ...
            {
                var elUsuarioYaTieneLlaveGratuita = await context.LlaveAPIs
        ...
        public async Task<ActionResult> Put(int id, LlaveActualizacionDTO llaveActualizacionDTO)
        {
            ...
            var llaveDB = await context.LlaveAPIs.FirstOrDefaultAsync(x => x.Id == id);
        ...
        public async Task<ActionResult> Delete (int id)
        {
            ...
            {
                ModelState.AddModelError("", "No pudes borrar una llave gratuita");
                return ValidationProblem();
            }
